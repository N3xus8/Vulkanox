...
use vulkano::{buffer::{Buffer, BufferCreateInfo, BufferUsage, Subbuffer}, memory::{allocator::{AllocationCreateInfo, FreeListAllocator, GenericMemoryAllocator, MemoryTypeFilter}, MemoryPropertyFlags}, DeviceSize};
use crate::error::Result;

pub fn setup_index_buffers(indices: Vec<u16>, memory_allocator: Arc<GenericMemoryAllocator<FreeListAllocator>>) -> Result<(Option<Subbuffer<[u32]>>, Option<Subbuffer<[u32]>>)> {
